...
- I first need to call real api , and then redirect user to deployments/:id . polling to see deployment status
...
- each project must have only 1 active present deployment as of curr time
